 ...
 */
class Utilisateurs extends \FT\CarnetBundle\Entity\Utilisateurs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'FT\\CarnetBundle\\Entity\\Utilisateurs' . "\0" . 'id', '' . "\0" . 'FT\\CarnetBundle\\Entity\\Utilisateurs' . "\0" . 'nom', '' . "\0" . 'FT\\CarnetBundle\\Entity\\Utilisateurs' . "\0" . 'prenom', '' . "\0" . 'FT\\CarnetBundle\\Entity\\Utilisateurs' . "\0" . 'mail', '' . "\0" . 'FT\\CarnetBundle\\Entity\\Utilisateurs' . "\0" . 'nom_user', '' . "\0" . 'FT\\CarnetBundle\\Entity\\Utilisateurs' . "\0" . 'mdp');
        }
